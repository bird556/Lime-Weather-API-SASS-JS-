function fetchWeatherData(city = 'Toronto') {
  ...
  fetch(`/api/weather?city=${city}`)
    ...
    .then((data) => {
      ...
      iconWeather.src = `/public/icons1/${iconId}`;
      ...
      if (code == 1000) {
        backgroundImage.src = `/public/img/${timeOfDay}/clear2.jpg`;
      } else if (
        code == 1003 ||
        code == 1006 ||
        code == 1030 ||
        ...
        backgroundImage.src = `/public/img/${timeOfDay}/cloudy.jpg`;
      } else if (
        code == 1063 ||
        code == 1150 ||
        code == 1180 ||
        ...
        backgroundImage.src = `/public/img/${timeOfDay}/rain.jpg`;
      } else if (code == 1009) {
        backgroundImage.src = `/public/img/${timeOfDay}/overcast.jpg`;
      } else if (
        code == 1066 ||
        code == 1169 ||
        code == 1172 ||
        ...
        backgroundImage.src = `/public/img/${timeOfDay}/snow.jpg`;
      } else if (code == 1087) {
        backgroundImage.src = `/public/img/${timeOfDay}/thunder.jpg`;
      }
